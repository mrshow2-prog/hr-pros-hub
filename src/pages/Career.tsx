    ...
    <main className="min-h-screen overflow-hidden bg-career-bg font-dm text-paper">
      <nav className="fixed left-0 right-0 top-0 z-50 border-b border-career-border bg-career-bg/95">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 md:px-8">
          ...
          <div className="flex items-center gap-2">
            <a href={BOOKING_HREF} className="inline-flex min-h-11 items-center bg-career-blue px-4 font-dm text-xs font-bold uppercase tracking-wider2 text-paper transition-colors hover:bg-career-deep">Book a free call</a>
          </div>
        </div>
      </nav>
      ...
      <section className="relative flex min-h-screen flex-col justify-end overflow-hidden px-6 pb-16 pt-28 md:px-10 md:pb-20 md:pt-32">
        ...
        <div className="relative z-10 max-w-5xl">
          ...
          <h1 className="mb-7 max-w-4xl font-serif text-5xl font-normal leading-[0.96] text-paper drop-shadow-2xl md:text-7xl lg:text-8xl">Your career,<br /><span className="italic text-career-sky">considered</span><span className="text-career-sky">.</span></h1>
          <p className="mb-9 max-w-xl text-base font-light leading-8 text-paper/70 md:text-lg">You're good at what you do. Your CV, your LinkedIn, and your ability to articulate your value should reflect that. Most people's don't. That's what we fix.</p>
          <div className="flex flex-wrap gap-3">
            <a href={BOOKING_HREF} className="inline-flex min-h-12 items-center border border-career-sky/30 px-7 font-dm text-xs font-bold uppercase tracking-wider2 text-career-sky transition-all hover:-translate-y-0.5 hover:bg-career-sky/10">Book a free discovery call</a>
