              ...
              {visibleBullets(exp).length > 0 && (
                <ul className="space-y-1.5">
                  {visibleBullets(exp).map((b) => (
                    <li key={b.id} className="flex gap-2 text-[13px] font-light leading-[1.65] text-ink/85">
                      <span className="relative shrink-0 top-[2px] text-sienna">—</span>
      ...
      <section className="mb-9">
        ...
        <ul className="space-y-1.5">
          {cv.achievements.filter(Boolean).map((a, i) => (
            <li key={i} className="flex gap-2 text-[13px] font-light leading-[1.65] text-ink/85">
              <span className="relative shrink-0 top-[2px] text-sienna">—</span>
